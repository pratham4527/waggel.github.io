...
echo " 
    ...
    <div id='cloths-slider1'><h1 id='cloths-title'></h1></div>
";
...
$sql = "SELECT * FROM `int123` WHERE type='electronics' ";
...
<style>
        ...
        #cloths-slider1{
            border:none;
             ...
             padding:0px; 
             height:40vh; 
            background: url(img/bannerele.jpg);
            width: 101%;
            background-size: 100%; 
...
echo "
    <div class='elebanner'>
        <img src='img/banner/tvad.gif' >
    </div>
    <div class='elebanner'>
        <img src='img/bannerele2.jpg' >
    </div>
    <div class='elebanner'>
        <img src='img/bannerele3.jpg' >
    </div>
    <div class='elebanner'>
        <img src='img/bannerele4.jpg' >
    </div>
